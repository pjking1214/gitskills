...
int main(int argc, char* argv[])
{
	...
	//1,计算5年定期本息	
	p1=money*(1+5*0.03);
	//2,计算先存2年定期，到期后将本息再存3年期
	p2=(money*(1+2*0.021))*(1+3*0.0275);
	//3,计算先存3年定期，到期后将本息再存2年期
	p3=(money*(1+3*0.0275))*(1+2*0.021);
	//4,计算存1年期，到期后将本息再存1年期，连续存5次	
	p4=money*pow((1+0.015),5);
	//5,计算存活期利息和	
	p5=1000*pow((1+0.0035/4),20);				
